...
function createReducer() {
    ...
    function applyUpdates(runtime, update) {
        ...
        if (update.observationIndex !== undefined &&
        ...
        if (update.observationCardinality !== undefined &&
        ...
        if (update.dynamicFeeConfig) {
            ...
            if (update.dynamicFeeConfig.baseFee !== undefined &&
            ...
            if (update.dynamicFeeConfig.scalingFactor !== undefined &&
