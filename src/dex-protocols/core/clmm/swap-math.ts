import { FEE_DENOMINATOR, Q96, MAX_UINT256 } from '@src/dex-protocols/core/clmm/constants';
import { divRoundingUp, mulDiv, mulDivRoundingUp, pow10 } from '@src/utils/math';
