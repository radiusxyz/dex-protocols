import { AMPLIFICATION_PRECISION, CURVE_FEE_DENOMINATOR } from '@src/domain/dex-protocols/core/stableswap/constants';
import { createReducer as createStableSwapReducer } from '@src/domain/dex-protocols/core/stableswap/reducer';
