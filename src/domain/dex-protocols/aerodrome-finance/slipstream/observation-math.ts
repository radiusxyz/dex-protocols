// src/domain/dex-protocols/aerodrome-finance/slipstream/observation-math.ts

import { U32 } from '@src/domain/dex-protocols/aerodrome-finance/slipstream/constants';
