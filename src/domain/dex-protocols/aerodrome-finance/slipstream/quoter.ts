// src/domain/protocols/aerodrome-finance/slipstream/quoter.ts

import { resolveSlipstreamFeePips } from '@src/domain/dex-protocols/aerodrome-finance/slipstream/fee';
import { observeTickCumulativesSlipstream } from '@src/domain/dex-protocols/aerodrome-finance/slipstream/observation-math';
import { uniswapV3Module } from '@src/domain/dex-protocols/uniswap/v3';
